...
public class Point implements Comparable<Point> {
     ...
     *
     * Here we use an inner class: we defined a class DistanceComparator inside the class Point, above
     * The comparator has access to the inner variables x and y of the point it is constructed from
     */
    public final Comparator<Point> DISTANCE_ORDER = new DistanceComparator();

    private static void sortArrayByDistanceToPoint(Point[] array, Point point){
        Arrays.sort(array, point.DISTANCE_ORDER);
    }
